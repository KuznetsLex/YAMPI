...
class DefiniteIntegralFunctionalTest {
    ...
    @Test
    void calculate1() {
        DefiniteIntegralFunctional<ExponentialFunction> expIntegral = new DefiniteIntegralFunctional<>(-5,5);
        ExponentialFunction exp = new ExponentialFunction(2,2,-5,5);
        assertEquals(40.0, expIntegral.calculate(exp));
    }

    @Test
    void calculate2() {
        DefiniteIntegralFunctional<RatioFunction> ratioIntegral = new DefiniteIntegralFunctional<>(10,50);
        RatioFunction ratio = new RatioFunction(7,9,6,5,10,50);
        assertEquals(47.2,ratioIntegral.calculate(ratio));
    }

    @Test
    void calculate3() {
        DefiniteIntegralFunctional<LinearFunction> linearIntegral = new DefiniteIntegralFunctional<>(0,100);
    ...
    @Test
    void calculate4() {
        DefiniteIntegralFunctional<LinearFunction> linearIntegral = new DefiniteIntegralFunctional<>(-100,100);
